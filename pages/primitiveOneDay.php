    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <a href="http://www-personal.umich.edu/~zhaoding/cav-data.html#trafficnet#primitive"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>  </a>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <?php
                    $rs = mysqli_query($conn,"SELECT count(*) FROM primitiveOneDay " );
                    $rows = mysqli_fetch_array($rs);
                    $count = intval($rows[0]);
                ?>
                  <h3 class="box-title">Primitive One Day (shown 10 out of <b><?=$count?></b> entries)</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                    <?php
                    $rs = mysqli_query($conn,"SELECT * FROM primitiveOneDay limit 10" );
